...
async def record_stock_in(
    ...
    purchase_bill = Bill(
        ...
        party_mobile=supplier_obj.mobile if supplier_obj else None,
        party_gst=supplier_obj.gst_number if supplier_obj else None,
        party_address=supplier_obj.address if supplier_obj else None,
