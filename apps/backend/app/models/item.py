...
class Item(Base, TimestampMixin):
    ...
    unit: Mapped[str] = mapped_column(String(20), default="PCS", nullable=False)  # PCS, EA, KG, LTR, BOX, MTR
    secondary_unit: Mapped[Optional[str]] = mapped_column(String(20), default="CS", nullable=True)  # CS (Case)
    units_per_case: Mapped[float] = mapped_column(Float, default=1.0, nullable=False)  # 1 CS = X EA/PCS
